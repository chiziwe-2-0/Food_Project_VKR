...
$query = "SELECT data.data, bluda.name_bluda, kat.name_kat, bluda.vyhod_bluda, kat.ed_izm, menu.skolko_gotovit
...
if($result)
{
    ...
    echo "<table align='center' border=1px><tr><th>data</th><th>name_bluda</th><th>name_kat</th><th>vyhod_bluda</th><th>ed_izm</th><th>skolko_gotovit</th></tr>";
    for ($i = 0 ; $i < $rows ; ++$i)
    {
