...
if($result)
{
    ...
    echo "<table align='center' border=1px><tr><th>id_stroki</th><th>data</th><th>name_bluda</th><th>name_kat</th><th>vyhod_bluda</th><th>ed_izm</th><th>skolko_gotovit</th></tr>";
    for ($i = 0 ; $i < $rows ; ++$i)
    {
