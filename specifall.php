...
$query = "SELECT specif.id_zapisi, data.data, klienty.id_klienta, klienty.name_klienta, tipy.name_tipa, zayavki.kolvo_porci, bluda.name_bluda, kat.name_kat, bluda.vyhod_bluda, kat.ed_izm
...
if($result)
{
    ...
    echo "<table align='center' border=1px><tr><th>id_zapisi</th><th>data</th><th>id_klienta</th><th>name_klienta</th><th>name_tipa</th><th>kolvo_porci</th><th>name_bluda</th><th>name_kat</th><th>vyhod_bluda</th><th>ed_izm</th></tr>";
    for ($i = 0 ; $i < $rows ; ++$i)
    {
